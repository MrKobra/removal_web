...
<?php get_template_part('template-parts/catalog', 'items', ['heading' => 'С этим товаром часто заказывают', 'posts_per_page' => 8, 'orderby' => 'rand', 'cat' => $product->get_category_ids(), 'class' => 'single-product-commend-slider']) ?>
